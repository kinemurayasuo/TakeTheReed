...
<body>
   ...
   <section class="checkout spad">
     ...
     <form action="/user/pwchk" method="post" onsubmit="return pwCheck();">
			<table style="margin-left: auto; margin-right: auto;" class="checkout__input">
				...
				<tr>
					...
					<input type="submit" value="비밀번호 확인" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;"/>
					</td>
				</tr>
			</table>
		</form>  
