      ...
      <form action="/user/join" method="post" onsubmit="return formChk();">
		<Table style="margin-left:auto; margin-right:auto;" class="checkout__input">
			<tr>
				...
				<td><input type="button" id="user1" value="ID중복검사" onclick="idChk();" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;"></td>
			</tr>
			<tr>
				<td>이름</td>
				<td>
			...
			<tr>
				...
				<td><input type="button" value="닉네임중복검사" id="user2" onclick="nmChk();" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;"></td>
			</tr>
		    <tr>
				<td>전화번호</td>
			...
			<tr>
				<td></td>
				<td>
					<br><input type="submit" value="회원가입" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;">
				</td>
			</tr>
		</Table>
	 </form>     
