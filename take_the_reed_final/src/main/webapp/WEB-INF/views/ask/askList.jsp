		...
		<div class="row">
			<div class="col-md-12">
				<div class="shoping__cart__table">
					<form action="/ask/askList">
						<label><input type="radio" value="date_desc" name="sort">최신순</label>
						<label><input type="radio" value="date_asc" name="sort">오래된순</label>
						<input type="submit" value="정렬하기" class="site-btn3" style="height: 35px;padding-left: 15px;
									...
									<c:forEach items="${askList }" var="ask">
										...
										<tr>
											...
											<td class="shoping__cart__item"><a
												href="/ask/ask?askNum=${ask.askNum }"> ${ask.askTitle }
											</a></td>
											<td>${ask.userNm }</td>
											<td>${ask.askTime }</td>
										</tr>
				...
				<div style="text-align: center;">
					<span> <c:if test="${navi.currentPage > 1 }">
							<a
								href="/ask/askList?currentPage=${(navi.currentGroup - 1) * 5 + 1 }"
							...
							<c:if test="${pageNum == navi.currentPage }">
								<a href="/ask/askList?currentPage=${pageNum }"
										...
										<table class="sp--box">
											<tr>
												<td><select id="searchType" name="searchType">
														...
														<option value="askCon">내용</option>
														<option value="userNm">닉네임</option>
												</select></td>
												<td><input type="text" class="form-control"
													id="searchWord" placeholder="검색어 입력" name="searchWord">
												<input type="submit" value="검색" id="searchWord" class="site-btn3"
														onclick="JlistPaging();" style="width: 88px; height: 38px;"></td>
											</tr>
										</table>
									</div>
									<div class="col-lg-6_1 col-md-6 col-sm-6">
										<input type="button" value="글 쓰기"
											onclick="location.href = '/ask/askListWrite';" id="submit"
											class="site-btn3" style="margin-left: 800px;">
										</div>
											<div class="col-lg-6_1 col-md-6 col-sm-6">
										<input type="button" value="1대1 상담"
