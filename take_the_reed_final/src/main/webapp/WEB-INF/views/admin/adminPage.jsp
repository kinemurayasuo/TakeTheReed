						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								<div class="blog__item__pic">
									<input type="button" value="회원관련" class="button1"
										onclick="location.href = '/admin/userList'" id="submit">
									<div class="admin1">회원 관련 기능이 담긴 곳</div>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="blog__item">
								<div class="blog__item__pic">
									<input type="button" class="button1" value="도서 관련"
										onclick="location.href = '/admin/bookList'" id="submit">
									<div class="admin1">도서 관련 기능이 담긴 곳</div>
								</div>
							</div>
						</div>
					</div>
