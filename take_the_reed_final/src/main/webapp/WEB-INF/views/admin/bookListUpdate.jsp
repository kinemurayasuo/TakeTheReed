...
<body>
	...
	<c:if test="${loginId == 'admin'}">
		<section class="latest-product spad">
			<div class="container">
				<div class="row"
					style="flex: 0 0 100%; max-width: 100%; background-color: white; padding: 30px; padding-bottom: 82px; BORDER-RADIUS: 30PX 30PX; box-shadow: 10px 10px 4px rgb(0 0 0/ 10%);">
					<div class="col-lg-12">
						<div class="contact__form__title">
							<h2>관리자 책 업로드</h2>
						</div>
					</div>
					<form action="/admin/bookListUpdate" method="post"
						enctype="multipart/form-data" style="margin: auto;">
						<input type="hidden" name="bookNum" value="${bookDetail.bookNum }">
						<table border="1">
							<tr>
								<td colspan="4"><input type="text" id="bookName"
									name="bookName" placeholder="책 이름을 입력해주세요."
									style="width: 100%;"></td>
							</tr>
							<tr>
								<th>책 표지</th>
								<td colspan="3"><input type="file" name="uploadFile1">
								</td>
							</tr>
							<tr>
								<th>책 저자</th>
								<td><input type="text" id="bookWriter" name="bookWriter"
									style="width: 100%;"></td>
								<th>카테고리</th>
								<td><input type="text" id="bookCate" name="bookCate"
									style="width: 100%;"></td>
							</tr>
							<tr>
								<td colspan="4"><input type="file" name="uploadFile2">
								</td>
							</tr>
							<tr>
								<td colspan="4"><textarea rows="8" cols="115" id="bookCon"
										name="bookCon" placeholder="책설명을 입력해 주세요."></textarea></td>
							</tr>
							<tr>
								<td align="center" colspan="4"><input type="submit"
									value="작성하기" id="submit"> <input type="reset"
...
<c:if test="${loginId != 'admin'}">
	...
	<footer class="footer spad">
		<div class="container">
			...
			<div class="x">
				<div class="footer__widget">Copyright © 2022 take the reed
					(테이크 더 리드) ALL rights Reserved</div>
			</div>
		</div>
