...
<body>
				...
				<form action="/ask/askListWrite" method="post" class="form">
					<div class="row">
						<div class="col-lg-12 text-center">
							<input type="text" placeholder="タイトル" name="askTitle" id = "askTitle">
						</div>
						<div class="col-lg-12 text-center">
							<textarea placeholder="内容" name="askCon" id = "askCon"></textarea>
						</div>
					</div>
					<div>
						<button type="submit" class="site-btn1" onclick = "return askTable();" >作成する</button>
						<button type="submit" class="site-btn2">キャンセル</button>
					</div>
				</form>
			</div>
		</div>
	...
	function askTable() 
	{
	   ...
	   var result = true;
	   var wordChk = ["コハンヨン", "コハンヨンアホ", "覇王コハンヨン" ,"皇居", "靖国神社", "コハンヨンジャパノファイフ"];
