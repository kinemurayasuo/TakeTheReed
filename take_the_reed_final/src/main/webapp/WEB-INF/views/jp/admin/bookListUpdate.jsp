...
<body>
	...
	<!-- upload 시작 -->
		<form action="/admin/bookListUpdate" method="post" enctype = "multipart/form-data">
	      <input type="hidden" name="bookNum" value="${bookDetail.bookNum }">
	      <table border="1">
	         <tr>
	            <td colspan="4">
	               <input type="text" id="bookName" name="bookName" placeholder="本のタイトルを入力してください。" style="width:750px;">
	            </td>
	         </tr>
	         <tr>
	            <th>カバー</th>
	         ...
	         <tr>
	         	<td colspan="4">
	         		<textarea rows="8" cols="115" id="bookCon" name="bookCon" placeholder="本の説明を入力してください。"></textarea>
	         	</td>
	         </tr>
	         <tr>
	            <td align="center" colspan="4">
	               <input type="submit" value="アップロード" id="submit">
