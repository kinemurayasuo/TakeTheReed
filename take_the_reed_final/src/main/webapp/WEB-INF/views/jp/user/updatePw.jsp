...
<head>
	...
	<script type="text/javascript" src="/resources/js/user/jp/login.js"></script>
...
<body>
  ...
  <!-- Contact Form Begin -->
    <div class="contact-form spad">
      ...
      <!-- 비밀번호 빈칸 작성란  begin -->  
     <form action="/jpUser/updatePw" method="post" onsubmit="return loginCheck();">
			<table style="margin-left: auto; margin-right: auto;">
				...
				<tr>
					...
					<input type="submit" value="확인" style="font-family: 'IBM Plex Sans KR'; font-weight : bold;"/>
					</td>
				</tr>
			</table>
		</form>
