...
<body>
  ...
  <!-- Contact Form Begin -->
    <div class="contact-form spad">
      ...
      <!-- 로그인 빈칸 작성란  begin -->  
     <form action="/jpUser/login" method="post" onsubmit="return loginCheck();">
			<table style="margin-left: auto; margin-right: auto;">
				...
				<tr>
					...
					<input type="submit" value="ログイン" style="color:white; background-color:#324B32; font-family: 'IBM Plex Sans KR'; font-weight : bold;"/>
					</td>
				</tr>
			</table>
	      	<h4 align="center">ユーザID・パスワードを忘れた場合</h4>
			<div align="center" id="bos">
	      		<input type="button" value="ID/パスワードを忘れた場合 " style="color:white; background-color:#324B32; font-family: 'IBM Plex Sans KR'; width: 228px; height: 37pt; padding-left: 6px;" 
	      															onclick="location.href='/jpUser/find';">
	      	</div>
		</form>
