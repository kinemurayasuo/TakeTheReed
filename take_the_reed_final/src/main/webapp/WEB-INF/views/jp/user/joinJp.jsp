...
<head>
	...
	<script type="text/javascript" src="/resources/js/user/jp/join.js"></script>
		...
		<Table style="margin-left: auto; margin-right: auto;">
			<tr>
				...
				<td>
					...
					<input type="button" id="user1" value="重複チェック" style="color:white; background-color:#324B32; font-family: 'IBM Plex Sans KR'; font-weight : bold;"
																	onclick="idChk();">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<input type="button" value="重複チェック" id="user2" style="color:white; background-color:#324B32; font-family: 'IBM Plex Sans KR'; font-weight : bold;"
																					onclick="nmChk();">
				</td>
			</tr>
		    <tr>
			...
			<tr>
				<td colspan="2"><input type="submit" value="登録" style="color:white; background-color:#324B32; font-family: 'IBM Plex Sans KR'; font-weight : bold;"></td>
			</tr>
		</Table>
	</form>                     
    <!-- 회원가입 빈칸 작성란 end -->
