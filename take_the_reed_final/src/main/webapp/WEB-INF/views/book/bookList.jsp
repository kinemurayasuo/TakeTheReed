				...
				<div class="col-lg-8 col-md-7">
					...
					<div align="center">
						<c:if test="${navi.currentPage > 1 }">
							<a
								href="/book/bookList?currentPage=${(navi.currentGroup - 1) * 5 + 5 }"
								style="color: blue; text-decoration: none;"> ◀◀ </a>
							<a href="/book/bookList?currentPage=${navi.currentPage - 1 }"
								style="color: blue; text-decoration: none;"> ◀ </a>
						</c:if>
						...
						<c:forEach begin="${navi.startPageGroup }"
							...
							<c:if test="${pageNum == navi.currentPage }">
								<a href="/book/bookList?currentPage=${pageNum }"
						...
						<c:if test="${navi.currentPage < navi.totalPageCount }">
							<a href="/book/bookList?currentPage=${navi.currentPage + 1 }"
								style="color: blue; text-decoration: none;"> ▶ </a>
							<a
								href="/book/bookList?currentPage=${(navi.currentGroup + 1) * 5 + 1 }"
								style="color: blue; text-decoration: none;"> ▶▶ </a>
						</c:if>
					</div>
					<br>
										...
										<form action="/book/bookListSearch" method="get">
											...
											<div class="nice-select" tabindex="0">
												...
												<ul class="list">
													...
													<li data-value="bookCon" class="option">내용</li>
													<li data-value="bookCate" class="option">카테고리</li>
												</ul>
											</div>
