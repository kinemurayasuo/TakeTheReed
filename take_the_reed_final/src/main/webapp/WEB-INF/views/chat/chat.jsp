...
<body>
    ...
    <div class="contact-form spad">
        <div class="container" style="margin: auto; width: 830px;">
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact__form__title">
                        <h2 class = "chatTitle">Leave Message</h2>
                    </div>
                </div>
            </div>
            <div class = "chat">
		        <button type="button" onClick="openSocket();">채팅 참여</button>
		        <button type="button" onClick="closeSocket();">채팅 나가기</button>
		        <br/><br/>
		        	메시지 입력 :
		        <input type="text" id="sender" value="${sessionScope.loginName}" style="display: none;" />
		        <input type="text" id="messageinput" onkeydown="if(event.keyCode==13){send();}">
		        <button type="button" onclick="send();">전송</button>
		        <button type="button" onclick="javascript:clearText();">지우기</button>
    		</div>
		    <!-- 채팅 응답 -->
		    <div id="messages"></div>
        </div>
    ...
    <script src="/resources/js/chat/webSocket.js"></script>
