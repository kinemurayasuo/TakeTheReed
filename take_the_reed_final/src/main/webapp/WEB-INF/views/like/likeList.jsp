...
<body>
			...
			<div class="col-lg-8 col-md-7">
				...
				<div align="center">
					<c:if test="${navi.currentPage > 1 }">
						<a
							href="/like/likeList?currentPage=${(navi.currentGroup - 1) * 5 + 5 }"
							style="color: blue; text-decoration: none;"> ◀◀ </a>
						<a href="/like/likeList?currentPage=${navi.currentPage - 1 }"
							style="color: blue; text-decoration: none;"> ◀ </a>
					</c:if>
					...
					<c:forEach begin="${navi.startPageGroup }"
						...
						<c:if test="${pageNum == navi.currentPage }">
							<a href="/like/likeList?currentPage=${pageNum }"
					...
					<c:if test="${navi.currentPage < navi.totalPageCount }">
						<a href="/like/likeList?currentPage=${navi.currentPage + 1 }"
							style="color: blue; text-decoration: none;"> ▶ </a>
						<a
							href="/like/likeList?currentPage=${(navi.currentGroup + 1) * 5 + 1 }"
							style="color: blue; text-decoration: none;"> ▶▶ </a>
					</c:if>
				</div>
			</div>
	...
	<script type="text/javascript">
       function showPopup(bookNum) {
          window.open("/book/bookDetail?bookNum="+bookNum, "bookDetail", "width=1600, height=1400, left=100, top=50");
       }
