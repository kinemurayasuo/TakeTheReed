...
<body>
  ...
  <!-- 비밀번호 빈칸 작성란  begin -->        
   <section class="checkout spad">
     ...
     <form action="/eng/updatePw" method="post" onsubmit="return loginCheck();">
			<table style="margin-left: auto; margin-right: auto;" class="checkout__input">
				...
				<tr>
					...
					<input type="submit" value="Confirm" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;"/>
					</td>
				</tr>
			</table>
		</form>
