...
<script type="text/javascript">
	/* $(function() {
		$("#pwView").click(function() { 
			$("#findView").append("/WEB-INF/views/user/find/idFind.jsp");
		});
	}); */
	...
	/* $("#pwFind").click(function() {
		...
		$.ajax({
			url:"/WEB-INF/views/user/find/pwFind.jsp",
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
	...
	<table border="1" style="margin: auto; width: 800px; height: 400px;">
		<tr align="center" style="height: 70px;">
			<th><a href="#" id="idFind">Find ID</a></th>
			<th><a href="#" id="pwFind">Find PW</a></th>
		</tr>
		<tr>
			<td colspan="2" id="findView">
				<%-- <span id="findView"><%@ include file="/WEB-INF/views/user/find/idFind.jsp" %></span> --%>
				<div id="findView"><jsp:include page="/WEB-INF/views/eng/find/findingId.jsp"></jsp:include></div>
			</td>
		</tr>
	</table>
	<br>
