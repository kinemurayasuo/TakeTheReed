...
<input type = "button" value = "About Member" onclick="location.href = '/eadmin/userList'" id = "submit">
<input type = "button" value = "About Book" onclick="location.href = '/eadmin/bookList'" id = "submit">
