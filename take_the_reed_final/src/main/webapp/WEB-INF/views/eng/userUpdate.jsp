...
<head>
	...
	<script type="text/javascript" src="/resources/js/eng/userUpdate.js"></script>
...
<body>
	...
	<c:forEach items ="${userList }" var="user">
	 <form action="/eng/userUpdate" method="post" onsubmit="return formChk();">
	 	<table style="margin-left: auto; margin-right: auto;" class="checkout__input">
	        ...
	        <tr>
	         ...
	         <tr>
				...
				<td><input type="button" value="Duplicate Nickname check" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; width:160pt; height:37pt; font-weight:bold;"
													onclick="nmChk();"></td>
	        </tr>
	         <tr>
	            <td>MOBILE PHONE</td>
	        ...
	        <tr>
	        	<th></th>
	        	<td><input type="submit"  value="APPLY" style="background-color:#ADFA7E; color:black; font-family: 'IBM Plex Sans KR'; width: 150pt; height: 37pt; font-weight : bold;  position: relative; top: 12px;"></td>
	        </tr>
		</table>
	   </form> 
	  </c:forEach>	
