...
<head>
	...
	<script type="text/javascript" src="/resources/js/eng/join.js"></script>
...
<body>
  ...
  <!-- Humberger Begin -->
	...
	<!-- 회원가입 빈칸 작성란  begin -->  
      <form action="/eng/join" method="post" onsubmit="return formChk();">
		<Table style="margin-left:auto; margin-right:auto;" class="checkout__input">
			<tr>
				<td>ID</td>
				<td><input type="text" id="userId" name="userId"></td>
				<td><input type="button" id="user1" value="Duplicate ID check" onclick="idChk();" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;"></td>
			</tr>
			<tr>
				<td>NAME</td>
				<td>
			...
			<tr>
				...
				<td><input type="button" value="Duplicate Nickname check" id="user2" onclick="nmChk();" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;"></td>
			</tr>
		    <tr>
				<td>MOBILE PHONE</td>
			...
			<tr>
				<td>EMAIL</td>
				<td>
					<input  name="userEmail" value="${userEmail1}"  readonly/>
				</td>
			</tr>
			<tr>
				<td></td>
				<td>
					<br><input type="submit" value="APPLY" style="background-color:#ADFA7E; color:black; font-family:'IBM Plex Sans KR'; font-weight:bold;">
				</td>
			</tr>
		</Table>
	 </form>     
