...
<section>
    <form action = "/eask/askListWrite" method = "post" class = "form">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<table border = "1" class ="table">
						<tr>
							...
							<td class="td3">
								<input class="td3" type="text" name="askTitle" placeholder="Tell us what you need help with">
							</td>
						</tr>
						<tr>
							<td class="td2">Content</td>
							<td class="td4">
								<input class="td4" name="askCon" placeholder="Tell us what you need help with">
							</td>
						</tr>
					</table>
