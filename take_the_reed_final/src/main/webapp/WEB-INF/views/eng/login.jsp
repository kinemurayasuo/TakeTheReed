...
<body>
    ...
    <section class="checkout spad">
       ...
       <form action="/eng/login" method="post" onsubmit="return loginCheck();">
			<table style="margin-left:auto; margin-right:auto;" class="checkout__input">
				<tr>
					<td>ID</td>
					<td><input type="text" name="userId" id="checkId"/></td>
					<td><input type="submit" value="Lon In" style="background-color:#ADFA7E; color:black; width: 80pt; font-family:'IBM Plex Sans KR'; font-weight:bold;"/>
					</td>
				</tr>
				<tr>
	      	...
	      	<p align="center" style="font-weight:bold;">FORGOT YOUR ID/PASSWORD?</p>
			<div align="center"  class="checkout__input">
	      		<input type="button" value="Find ID/PASSWORD" style="font-family:'IBM Plex Sans KR'; color:black; width:150pt; height:37pt; font-weight:bold; background-color:#ADFA7E;" 
	      															onclick="location.href='/eng/findIdPw';">
	      	</div><br>
	  </form>
		
		<!-- 네이버 로그인 창으로 이동 -->
		<div id="naver_id_login" style="text-align:center"><a href="${url}">
		<img width="223" src="/resources/img/naver1.png"/></a>
		</div>
		<br>           
