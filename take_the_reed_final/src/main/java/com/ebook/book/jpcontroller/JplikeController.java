...
@Controller
@RequestMapping(value="/jpLike")
public class JplikeController {
	
	private static final Logger logger = LoggerFactory.getLogger(JplikeController.class);
	...
	public String likeList(@RequestParam(defaultValue = "1") int currentPage, String sort, Model model, HttpSession session) {
		...
		if(sort == null) { 
			...
			return "redirect:/jp/like/searchBoard?sort=" + sort;
		}
		 
		 return "/jp/like/likeList";
	 }
