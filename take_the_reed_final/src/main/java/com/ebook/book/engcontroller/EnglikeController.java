...
@Controller
@RequestMapping(value="/elike")
public class EnglikeController {
	
	private static final Logger logger = LoggerFactory.getLogger(EnglikeController.class);
	...
	public String likeList(@RequestParam(defaultValue = "1") int currentPage, String sort, Model model, HttpSession session) {
		...
		if(sort == null) { 
			...
			return "redirect:/eng/like/searchBoard?sort=" + sort;
		}
		 
		 return "/eng/like/likeList";
	 }
