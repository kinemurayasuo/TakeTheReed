...
@Controller
@RequestMapping(value = "/echeckout")
public class Engcheckoutcontroller {
	private static final Logger logger = LoggerFactory.getLogger(Engcheckoutcontroller.class);
